...
CLIENT_CLASS='net.jkcode.jkbenchmark.serializer.HessianSerializerPlayer'

java $JAVA_OPTS $JAVA_DEBUG_OPTS -cp $DIR/conf:$DIR/libs/* net.jkcode.jkbenchmark.BenchmarkApp $CLIENT_CLASS